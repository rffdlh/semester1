...
class Gaji extends Database
{
    ...
    public function index()
    {
        $data_gaji = mysqli_query(
            $this->koneksi,
            "SELECT gaji.gaji_id, gaji.karyawan_id, gaji.gaji_pokok, karyawan.karyawan_nama
            from gaji inner join karyawan on gaji.karyawan_id = karyawan.karyawan_id");
    ...
    public function update($gaji_id1, $karyawan_id1, $gaji_pokok1) {
        mysqli_query(
            $this->koneksi,
            "update gaji set karyawan_id = '$karyawan_id1', gaji_pokok = '$gaji_pokok1'

...
class Karyawan extends Database
{
    ...
    //Menambah Data
    public function create($karyawan_id1, $karyawan_nama1)
    {
        mysqli_query($this->koneksi, "insert into karyawan values
        (null,'$karyawan_id1', '$karyawan_nama1')");
    }
    public function edit($karyawan_id)
    {
        $data_karyawan = mysqli_query($this->koneksi,
        "select * from karyawan where karyawan_id = '$karyawan_id'");
    ...
    public function update($karyawan_id1, $karyawan_nama1)
    {
        ...
        "update karyawan set karyawan_nama ='$karyawan_nama1',
